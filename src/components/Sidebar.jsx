...
const Sidebar = ({
  ...
  heatDeathYear,
  setHeatDeathYear,
  showHeatwavePrevention,
  setShowHeatwavePrevention,
}) => {
  ...
  const handleScenarioClick = (yearValue) => {
    ...
    setBlock("")
    setHeatDeathYear("") 
    // Set layer to None when selecting heat risk scenario year
    if (typeof setSelectedLayer === "function") {
      setSelectedLayer("None");
    }
    // Clear heatwave prevention map
    if (typeof setShowHeatwavePrevention === "function") {
      setShowHeatwavePrevention(false);
    }
  };
  ...
  // Handle Health Facilities button click - shows heatwave prevention map
  const handleHealthFacilitiesClick = () => {
    if (typeof setShowHeatwavePrevention === "function") {
      setShowHeatwavePrevention(true);
    }
    // Reset all other options to None or ""
    if (typeof setMap === "function") {
      setMap("");
    }
    if (typeof setSelectedLayer === "function") {
  ...
  return (
    ...
    setBlock("");
        ...
        <div className="mt-8 pt-4 border-t border-gray-200">
          <button
            onClick={handleHealthFacilitiesClick}
