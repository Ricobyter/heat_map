...
const Sidebar = () => {
  ...
  return (
    <div className="w-72 bg-white p-6 min-h-screen border-r border-gray-200">
      {/* Time Period */}
      <div className="mb-6">
        <label className="block text-sm font-semibold text-gray-800 mb-3">Time Period</label>
        <select className="w-full p-3 bg-white border border-gray-300 rounded text-gray-800 text-sm">
          <option>Today</option>
      ...
      <div className="mb-8">
        ...
        <select className="w-full p-3 bg-white border border-gray-300 rounded text-gray-800 text-sm mb-4">
              ...
              {row.map((year) => (
                <button
                  ...
                  className={`py-2 px-1 text-xs font-medium rounded ${
                    selectedYear === year ? "bg-green-600 text-white" : "bg-gray-200 text-gray-800 hover:bg-gray-300"
                  }`}
                >
                  {year}
                </button>
      ...
      <div className="mt-8">
        <button className="w-full bg-green-600 text-white py-3 px-4 rounded font-semibold hover:bg-green-700 transition-colors">
          Run Simulation
        </button>
      </div>
    </div>
