...
export default function HRI2040AreaChart() {
  ...
  const hri2040Data = [
    {
      ...
      gradientId: "moderateHRI2040Gradient",
      gradientFrom: "#b6eaff",
      gradientTo: "#00bfff",
      color: "#46b1e1",
    },
    {
      ...
      gradientId: "highHRI2040Gradient",
      gradientFrom: "#a9bcec",
      gradientTo: "#465f91",
      color: "#465f91",
    },
    {
      ...
      gradientId: "veryHighHRI2040Gradient",
      gradientFrom: "#d5c7f6",
      gradientTo: "#7d50c7",
      color: "#7d50c7",
    },
  ...
  return (
    <div className="max-w-xs mx-auto my-0 relative">
      ...
      <div className="flex justify-center items-end h-45 gap-2">
        {hri2040Data.map(({ label, value, gradientId, gradientFrom, gradientTo, color }) => {
          const svgHeight = 130;
          const svgWidth = 40;
              ...
              {isHovered && (
                ...
                >
                  <div className="text-xs font-semibold text-gray-700 mb-2">
                    {label} HRI 2040 Blocks ({districts.length})
                  </div>
                  {districts.length > 0 ? (
