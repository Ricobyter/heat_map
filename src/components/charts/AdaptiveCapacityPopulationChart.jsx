  ...
  const data = [
    {
      ...
      gradientId: 'lowAdaptiveGradient',
      gradientFrom: '#b6eaff',
      gradientTo: '#00bfff',
      color: '#46b1e1'
    },
    {
      ...
      gradientId: 'mediumAdaptiveGradient',
      gradientFrom: '#a9bcec',
      gradientTo: '#465f91',
      color: '#465f91'
    },
    {
      ...
      gradientId: 'highAdaptiveGradient',
      gradientFrom: '#d5c7f6',
      gradientTo: '#7d50c7',
      color: '#7d50c7'
    }
  ...
  return (
    <div className="max-w-xs mx-auto my-0 relative">
      <h2 className="text-center text-sm font-semibold mb-4">
        Category Wise Population Falling <br /> in Adaptive Capacity 
      </h2>
