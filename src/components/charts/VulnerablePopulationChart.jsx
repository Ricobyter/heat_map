  ...
  const data = [
    {
      ...
      gradientId: 'lowVulnerabilityGradient',
      gradientFrom: '#b6eaff',
      gradientTo: '#00bfff',
      color: '#46b1e1'
    },
    {
      ...
      gradientId: 'mediumVulnerabilityGradient',
      gradientFrom: '#a9bcec',
      gradientTo: '#465f91',
      color: '#465f91'
    },
    {
      ...
      gradientId: 'highVulnerabilityGradient',
      gradientFrom: '#d5c7f6',
      gradientTo: '#7d50c7',
      color: '#7d50c7'
    }
            ...
            >
              <svg width={svgWidth} height={svgHeight} className="block">
                ...
                <rect
                  ...
                  width={svgWidth}
                  height={svgHeight}
                  fill={`url(#lines-${label}-vulnerable)`}
                  rx="12"
                />
                {/* Colored Value Bar */}
                <rect
