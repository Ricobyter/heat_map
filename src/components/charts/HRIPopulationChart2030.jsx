...
export default function HRIPopulationChart2030() {
  ...
  const hriData = [
    {
      label: "Moderate",
      value: calculatePopulationPercentages().find(item => item.category === 'Moderate')?.percentage || 0,
      gradientId: "moderateHRIGradient",
      gradientFrom: "#b6eaff",
      gradientTo: "#00bfff",
      color: "#46b1e1",
    },
    ...
    {
      label: "Very High",
      value: calculatePopulationPercentages().find(item => item.category === 'Very High')?.percentage || 0,
      gradientId: "veryHighHRIGradient",
      gradientFrom: "#d5c7f6",
      gradientTo: "#7d50c7",
      color: "#7d50c7",
    },
              ...
              {isHovered && (
                ...
                >
                  <div className="text-xs font-semibold text-gray-700 mb-2">
                    {label} HRI Blocks ({districts.length})
                  </div>
                  {districts.length > 0 ? (
